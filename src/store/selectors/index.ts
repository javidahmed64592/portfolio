...
export const selectHomePageDataLoading = (state: RootState) =>
  state.homePageData.loading;
export const selectHomePageDataError = (state: RootState) =>
  state.homePageData.error;
...
export const selectExperiencePageData = (state: RootState) =>
  state.experiencePageData.data;
export const selectExperiencePageDataLoading = (state: RootState) =>
  state.experiencePageData.loading;
export const selectExperiencePageDataError = (state: RootState) =>
  state.experiencePageData.error;
...
export const selectProjectsPageData = (state: RootState) =>
  state.projectsPageData.data;
export const selectProjectsPageDataLoading = (state: RootState) =>
  state.projectsPageData.loading;
export const selectProjectsPageDataError = (state: RootState) =>
  state.projectsPageData.error;
...
export const selectAllDataLoading = createSelector(
  [
    ...
    selectHomePageDataLoading,
    selectExperiencePageDataLoading,
    selectProjectsPageDataLoading,
  ],
  (
    appDataLoading,
    homePageDataLoading,
    experiencePageDataLoading,
    projectsPageDataLoading
  ) =>
    appDataLoading ||
    homePageDataLoading ||
    experiencePageDataLoading ||
...
export const selectAllDataErrors = createSelector(
  [
    selectAppDataError,
    selectHomePageDataError,
    selectExperiencePageDataError,
    selectProjectsPageDataError,
  ],
  (
    appDataError,
    homePageDataError,
    experiencePageDataError,
